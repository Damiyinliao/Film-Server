...
export class SimulationService {
  ...
  async create(createSimulationDto: CreateSimulationDto) {
    ...
    let simulation = await this.SimulationRepo.findOne({where:{simulation_id}});
    if(simulation){
    ...
    let newSimulation = this.SimulationRepo.create(createSimulationDto);
    return await this.SimulationRepo.save(newSimulation);
  }
